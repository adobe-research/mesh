...
/**
 * logwarning(x) == Logging.warning({@link ToStr tostr}(x))
 *
 * @author Brent Baker
 */
public final class LogWarning extends IntrinsicLambda
{
    ...
    public static Tuple invoke(final Object obj)
    {
        ...
        Logging.warning(ToStr.invoke(obj).replaceAll("[{]", "'{'").replaceAll("[{]", "'}'"));
        return Tuple.UNIT;
    }
}