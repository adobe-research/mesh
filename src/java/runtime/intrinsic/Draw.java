 ...
 * @author Basil Hosmer
 */
public final class Draw extends IntrinsicLambda
{
    public static final String NAME = "draw";

    public static final Type TYPE = Types.fun(
        Types.tup(Types.INT, Types.INT), Types.list(Types.INT));
    ...
    public static PersistentList invoke(final int n, final int max)
    {
