 ...
 * @author Basil Hosmer
 */
public final class IsKey extends IntrinsicLambda
{
    public static final String NAME = "iskey";

    public static final TypeParam K = new TypeParam("K");
    public static final TypeParam V = new TypeParam("V");
    public static final Type MAP_KV = Types.map(K, V);

    public static final Type TYPE =
        Types.fun(Types.tup(MAP_KV, K), Types.BOOL);
