...
public class Import
{
    ...
    public Import(final Module module, final String qualifier, final WhiteList whitelist)
    {
        this.module = module;
    ...
    // stripped off.  If there was no match or a whitelist violation, null is returned.
    ...
    {
        String base = checkQualifierAndWhiteList(qname);
        if (base != null) 
        {
            if (module.isExported(base)) 
                return module.findValueBinding(base);
        }
        return null;
    }
    ...
    public TypeDef findTypeDef(final String qname) 
    {
        ...
        {
            if (module.isExported(base)) 
                return module.findType(base);
        }
        return null;
    }

    public boolean isNamespaceImported(final String ns)
    {
        return whitelist.allowsNamespace(ns);
    }
}
